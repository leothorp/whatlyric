...
/***/ function(module, exports, __webpack_require__) {
	...
	var SongSearchMain = __webpack_require__(160);

	//Render the top level component into the DOM.
	ReactDOM.render(React.createElement(SongSearchMain, null), document.getElementById('search-container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	;
	var React = __webpack_require__(2);
	var SearchBar = __webpack_require__(161);
	var SearchResults = __webpack_require__(162);
	var SelectedLyrics = __webpack_require__(164);
	...
	var SongSearchMain = React.createClass({
	  ...
	  render: function () {
	    ...
	    if (this.state.resultClicked) {
	      resultsOrSelectedLyrics = React.createElement(SelectedLyrics, { lyrics: this.state.selectedLyrics });
	    } else {
	      //pass props to SearchResults for the current results and the onSongSelection method.
	      resultsOrSelectedLyrics = React.createElement(SearchResults, { results: this.state.results,
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(SearchBar, { searchText: this.state.searchText, onSearchInput: this.onSearchInput }),
	        React.createElement(
	          'div',
	          null,
	          React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	;
	var React = __webpack_require__(2);
	var SongResult = __webpack_require__(163);
	...
	var SearchResults = React.createClass({
	  ...
	  render: function () {
	    var resultEntries = this.props.results.map((function (result, index) {
	      return React.createElement(SongResult, { song: result, key: index, onSongSelection: this.props.onSongSelection });
	    }).bind(this));
	    return React.createElement(
	      'ul',
